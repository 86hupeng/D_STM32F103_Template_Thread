...
uint16 unFN_W5500WriteBuf(uint32 addrbsb,uint8* buf,uint16 len);	/*向W5500写入len字节数据*/
uint16 unFN_W5500ReadBuf(uint32 addrbsb, uint8* buf,uint16 len);	/*从W5500读出len字节数据*/
